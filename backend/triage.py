...
EMERGENCY_KEYWORDS = [
    ...
    "heart attack", "stroke", "paralysis",
    "face drooping", "arm weakness", "sudden weakness",
    ...
    "बेहोश", "होश नहीं", "दौरा", "मिर्गी",
    "बहुत तेज बुखार", "खून नहीं रुक रहा", "लकवा",
    "अचानक कमजोरी",

    # ── Tamil ────────────────────────────────────────────────────
    "மார்பு வலி", "மூச்சு திணறல்", "மூச்சு வரவில்லை",
    "நினைவு இழந்தார்", "வலிப்பு", "இரத்தம் நிற்கவில்லை",

    # ── Telugu ───────────────────────────────────────────────────
    "ఛాతీ నొప్పి", "శ్వాస తీసుకోలేను", "స్పృహ కోల్పోయాను",
    "మూర్ఛ", "రక్తం ఆగడం లేదు", "తీవ్రమైన జ్వరం",

    # ── Kannada ──────────────────────────────────────────────────
    "ಎದೆ ನೋವು", "ಉಸಿರಾಡಲು ಕಷ್ಟ", "ಎಚ್ಚರ ತಪ್ಪಿದೆ",
    "ರಕ್ತ ನಿಲ್ಲುತ್ತಿಲ್ಲ", "ತೀವ್ರ ಜ್ವರ",
]

# ── YELLOW: Monitor keywords ─────────────────────────────────────
MONITOR_KEYWORDS = [
    "fever for 3 days", "fever 3 days", "persistent fever",
    "high fever", "fever since",
    "rash", "skin rash", "spots on skin",
    "vomiting", "vomit", "keep vomiting",
    "diarrhoea", "diarrhea", "loose motions",
    "blood in urine", "blood in stool",
    "joint pain", "severe joint",
    "dengue", "malaria", "typhoid", "jaundice",
    "3 दिन से बुखार", "उल्टी", "दस्त", "खून",
    "மூன்று நாட்களாக காய்ச்சல்", "வாந்தி",
    "మూడు రోజుల జ్వరం", "వాంతి",
]
...
def _emergency_message(triggered_kw: str) -> str:
    ...
    if any(ord(c) > 0x0900 for c in triggered_kw):   # Hindi
        return (
            "🚨 यह आपातकाल है। तुरंत 108 पर कॉल करें "
            "या नजदीकी अस्पताल जाएं। देरी मत करें।"
        )
