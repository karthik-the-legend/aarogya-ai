...
r = requests.post(f"{BASE_URL}/ask", json={
    "query": "", "lang_code": "en", "language_name": "English"
})
...
r = requests.post(f"{BASE_URL}/ask", json={
    "query": long_query[:500], "lang_code": "en", "language_name": "English"
})
...
r = requests.post(f"{BASE_URL}/ask", json={
    "query": "xyzabc123!!!???", "lang_code": "en", "language_name": "English"
})
...
r = requests.post(f"{BASE_URL}/ask", json={
    ...
    "lang_code": "en", "language_name": "English"
})
data = r.json()
...
print("\nTest 5: Unknown language code")
r = requests.post(f"{BASE_URL}/ask", json={
    "query": "I have fever", "lang_code": "xx", "language_name": "Unknown"
})
print(f"  Status : {r.status_code}")
