...
dataset = {
    ...
    "triage_tests": [
        # Hindi RED (5)
        {
            "id": "T001",
            "lang": "hi",
            "query": "सीने में दर्द है और सांस नहीं आ रही",
            "expected": "red",
        },
        ...
        {"id": "T003", "lang": "hi", "query": "दौरा पड़ा है", "expected": "red"},
        {
            "id": "T004",
            "lang": "hi",
            "query": "बहुत तेज बुखार और खून नहीं रुक रहा",
            "expected": "red",
        },
        ...
        # Tamil RED (5)
        {
            "id": "T006",
            "lang": "ta",
            "query": "மார்பு வலி மிகவும் கடுமையாக உள்ளது",
            "expected": "red",
        },
        {
            "id": "T007",
            "lang": "ta",
            "query": "மூச்சு திணறல் இருக்கிறது",
            "expected": "red",
        },
        ...
        # Telugu RED (5)
        {
            "id": "T011",
            "lang": "te",
            "query": "ఛాతీ నొప్పి చాలా ఎక్కువగా ఉంది",
            "expected": "red",
        },
        ...
        # Kannada RED (5)
        {
            "id": "T016",
            "lang": "kn",
            "query": "ಎದೆ ನೋವು ತುಂಬಾ ಜಾಸ್ತಿ ಇದೆ",
            "expected": "red",
        },
